...
class CloudKitManager {
    ...
    } // if fin is logged in on his iPhone, this is going to use his recordID (FN 2817) to fetch his record
    ...
    } // Bring back the record for whatever item has that ID (starship blaster, trooper's gun)
    ...
    } // Bring back all the records for the specifide type (all trooper records, all starship blaster records, all trooper gun records)
    ...
    } // retrieves the logged in user's record, and then all of the records that belong to that specific user --> Get Finn's and then get all of the records associated with him (gun record, helmet record, etc.)
    ...
    } // Get all the records that were created between a start and end date (if you want the old storm trooper helmets records, you might use this)
    ...
    } // The record with the specified ID will be DESTROYED
    ...
    } // Find the youinglings for these IDs, and kill their records
    ...
    } // Give your excuse.. if you dont want alert to pop up right away this is where you change that
    ...
    } // can you come out and play? are you avaiable?
    //capstone?? able to be discoverable (search for a person)
    ...
    } // Find out yes or no. if no, prepare excuse
